...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(c => c
            .setName(getMainTranslation("start",true))
            .setDescriptionLocalizations(getAllTranslation("start",true))
        ...
        switch (interaction.options.getSubcommandGroup()) {
            default:
                switch (interaction.options.getSubcommand()) {
                    case getMainTranslation("start",true):
                        ...
                        if (timeo) {
                            ...
                            switch (places.length) {
                                case 0:
                                    ...
                                    break
                                case 1:
                                    const exploration = await startExploration(interaction)
                                    const embed = new EmbedBuilder()
                                        .setColor(0x00cc66)
                                        .setTitle(getTranslation("exploration", interaction.locale))
